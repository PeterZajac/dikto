...
const STRINGS = {
  ...
  "nav.notes": { en: "Notes", sk: "Poznámky" },
  ...
  // ---- notes page ----
  "notes.title": { en: "Notes", sk: "Poznámky" },
  "notes.subtitle": {
    en: "Dictate straight into a note — the text lands where the caret is.",
    sk: "Diktuj rovno do poznámky — text pristane tam, kde bliká kurzor.",
  },
  "notes.new": { en: "New note", sk: "Nová poznámka" },
  "notes.searchPlaceholder": { en: "Search notes…", sk: "Hľadať v poznámkach…" },
  "notes.clearSearch": { en: "Clear search", sk: "Vymazať hľadanie" },
  "notes.untitled": { en: "Untitled", sk: "Bez názvu" },
  "notes.count.one": { en: "{n} note", sk: "{n} poznámka" },
  "notes.count.few": { en: "{n} notes", sk: "{n} poznámky" },
  "notes.count.many": { en: "{n} notes", sk: "{n} poznámok" },
  "notes.loadError": {
    en: "Couldn't load notes. Try restarting the app.",
    sk: "Poznámky sa nepodarilo načítať. Skús reštartovať aplikáciu.",
  },
  "notes.empty.title": { en: "No notes yet…", sk: "Zatiaľ žiadne poznámky…" },
  "notes.empty.hint": {
    en: "Create one, click into it and start dictating.",
    sk: "Vytvor si poznámku, klikni do nej a začni diktovať.",
  },
  "notes.noResults.title": { en: "Nothing found", sk: "Nič sa nenašlo" },
  "notes.noResults.hint": { en: "No note matches “{q}”.", sk: "Pre „{q}“ sme nenašli žiadnu poznámku." },
  "notes.none.title": { en: "No note selected", sk: "Žiadna poznámka" },
  "notes.none.hint": { en: "Pick a note on the left, or create a new one.", sk: "Vyber poznámku vľavo alebo si vytvor novú." },
  "notes.titlePlaceholder": { en: "Title", sk: "Názov" },
  "notes.bodyPlaceholder": { en: "Write or dictate…", sk: "Píš alebo diktuj…" },
  "notes.dictationHint": { en: "Dictation lands here · {key}", sk: "Diktovanie pristane sem · {key}" },
  "notes.delete": { en: "Delete", sk: "Zmazať" },
  "notes.deleteConfirm": { en: "Really delete?", sk: "Naozaj zmazať?" },
  "notes.saved": { en: "Saved", sk: "Uložené" },
